...
from config.config import wantedGenre, lemmy_instance, title, community_id, last_post_id, release_day, username_or_email, password, last_post_date
...
while loop_bot == True:
    if currentWeekday == release_day and does_post_exist == False:
        ...
        # Print data into the console (for now)
        body = ""
